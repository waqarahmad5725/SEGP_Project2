<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page_funds.aspx.cs" Inherits="SEGP_PROJECTNEWWW.Theme.unify.Page_funds" %>
...
<div class="wrapper">
    ...
    <div class="container content">
    	<div class="row">
            <div class="col-md-9">
    			<!-- General Questions -->
                <div class="headline"><h2>General Funds</h2></div>
                <div class="panel-group acc-v1 margin-bottom-40" id="accordion">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                                    1. A Practical and Low-Cost Solar Energy System
                                </a>
                            </h4>
                        </div>
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                               General Grant is 100K from well reputed comapany for shared project
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                    2. A Solar Energy System Based on Nano-Antennas
                                </a>
                            </h4>
                        </div>
                        <div id="collapseTwo" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>45K from punjab IT board.</p>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                                    3. An Efficient Multilevel Inverter
                                </a>
                            </h4>
                        </div>
                        <div id="collapseThree" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>200k from Head of Electrical department</p>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
                                    4. Wind Energy Pilot Power Project
                                </a>
                            </h4>
                        </div>
                        <div id="collapseFour" class="panel-collapse collapse">
                            <div class="panel-body">
                                50K donated from lab engineers.
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseFive">
                                    5.. GSHP Free Power Efficient Geothermal Cooling/Heating System
                                </a>
                            </h4>
                        </div>
                        <div id="collapseFive" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>200k donated from IEEE for  reasearch purpose</p>
    		...
    		<div class="col-md-3">
                ...
                <ul class="list-unstyled who margin-bottom-30">
                    <li><a ><i class="fa fa-home"></i>Namal College Mianwal</a></li>
                    <li><a ><i class="fa fa-globe"></i>Talagang Road, Mianwali,Pakistan</a></li>
                    <li><a ><i class="fa fa-envelope"></i>info@namal.edu.pk</a></li>
                    <li><a ><i class="fa fa-phone"></i>+92 (459) 236995</a></li>
                    
                </ul>
                <!-- End Contacts -->

            	<!-- Business Hours -->
                <div class="headline"><h2>Working Hours</h2></div>
                ...
                <div  class="magazine-sb-social margin-bottom-20" ">
                    ...
                    <a   class="btn btn-success rounded " href ="https://www.namal.edu.pk/donations/" ><h2 class="bg-color-white"><b> Donate Us</b></h2></a>
