<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="3page1_index.aspx.cs" Inherits="SEGP_PROJECTNEWWW.Theme.unify._3page1_index" %>
...
<div class="wrapper">
		...
		<div class="collapse navbar-collapse mega-menu navbar-responsive-collapse">
			<div class="container" style="margin-left:-70px">
				<ul class="nav navbar-nav">
					...
					<!-- End Home -->
                       <li >
                        <a href="3page_profile.aspx">My Profile</a>
					</li>

					
					<li >							
                        <a href="3page_progress.aspx">Progress</a>


					</li>
                   <li >
                         <a href="3page_project_detail.aspx">Project-Details  </a>
					</li>
                     <li >
                      <a href="3page_project_record.aspx">Project-Records</a>
					</li>
	...
	<div class="container content-sm">
        ...
        <br>
        <div class="marquee">
     <b id = "headline"><u><h4>Head Line... </b></h4><marquee    behaviour = "scroll" direction ="left"  height="80"><h2><b> Welocme to Namal's research portal </b></h2></marquee>  
        </div>
        
		<!-- Recent Works -->
		<div class="headline"><h2>Assinged Projects</h2></div>
