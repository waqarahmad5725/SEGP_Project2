<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SEGP_PROJECTNEWWW.Theme.unify.index" %>
...
<div class="wrapper">
		...
		<div class="container">
			...
			<div class="topbar">
				<ul class="loginbar pull-right">
					...
					<li><a href="page_faq1.aspx"><b >Help</b></a></li>

					    
					<li class="topbar-devider"></li>
					<li><a href="Page_login1.aspx"><b>Login</b></a></li>
				</ul>
			</div>
			<!-- End Topbar -->
			...
			<div class="container">
				<ul class="nav navbar-nav">
					...
					<li >
                        ...
                        <a href="Page_contact.aspx">Contact Us</a>
	...
	<div class="slider-inner">
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				<h2><i>Reasearch &amp; Creativity</i> <br /> <i>Automation</i> <br /> <i>Innovation</i></h2>
				<p><i>"Research is what i am doing</i> <br /> <i>when i dont knaw that what</i> <br /> <i>
I am doing"   &nbsp&nbsp&nbsp&nbsp (Von Broun) </i></p>
				<div class="da-img">  
			...
			<div class="da-slide">
				<h2><i>USING BEST WEB</i> <br /> <i>SOLUTIONS WITH</i> <br /> <i>aspx5/CSS3</i></h2>
				<p><i>Lorem ipsum dolor amet</i> <br /> <i>tempor incididunt ut</i> <br /> <i>veniam omnis </i></p>
				<div class="da-img"><img src="assets/plugins/parallax-slider/img/aspx5andcss3.png" alt="image01" /></div>
			</div>
			<div class="da-arrows">
	...
	<div class="container content-sm">
        ...
        <div class="marquee">
     <b id = "headline"><u><h4>Head Line... </b></h4><marquee    behaviour = "scroll" direction ="left"  height="50"><h2><b> Welocme to Namal's research portal </b></h2></marquee>  
        
            </div>
        
		<!-- Recent Works -->
		<div class="headline"><h2>Current Projects</h2></div>
		...
		<div class="row margin-bottom-20">
			<div class="col-md-3 col-sm-6">
				<div class="thumbnails thumbnail-style thumbnail-kenburn">
					...
					<div class="caption">
						<h3><a class="hover-effect" href="#">Project Five</a></h3>
						<p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, justo sit amet risus etiam porta sem.</p>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6">
				<div class="thumbnails thumbnail-style thumbnail-kenburn">
					...
					<div class="caption">
						<h3><a class="hover-effect" href="#">Project Six</a></h3>
						<p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, justo sit amet risus etiam porta sem.</p>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6">
				<div class="thumbnails thumbnail-style thumbnail-kenburn">
					...
					<div class="caption">
						<h3><a class="hover-effect" href="#">Project Seven</a></h3>
						<p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, justo sit amet risus etiam porta sem.</p>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6">
				<div class="thumbnails thumbnail-style thumbnail-kenburn">
					...
					<div class="caption">
						<h3><a class="hover-effect" href="#">Project Eight</a></h3>
						<p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, justo sit amet risus etiam porta sem.</p>
					</div>
				</div>
			</div>
